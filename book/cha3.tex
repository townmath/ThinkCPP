...
To make your life easier, you can write {\tt using namespace std;} whenever
you use {\tt iostream}.  However, in general it is not good practice, since it imports the 
entirety of std into your program.  This can become a problem when your programs get 
more complicated, but for this course it is an acceptable time-saving device. 
