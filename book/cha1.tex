...
%\begin{figure}
%	\centering
	\epsfig{figure=interpret.eps}
%	\caption{test}
%	\Description[source code->interpreter->console]{The interpreter reads the source code and the result appears on the screen.}
%\end{figure}
}%centerline
\vspace{0.1in}
